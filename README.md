...
- O código-fonte, credenciais e dados de usuários não são armazenados aqui.
- Releases são preparadas como rascunho e publicadas somente depois dos testes reais no Windows.

Não execute arquivos publicados fora deste repositório oficial.
